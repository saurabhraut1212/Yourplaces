...
const Auth = () => {
    ...
    const authSubmitHandler = async (event) => {
        ...
        if (isLoginMode) {
            ...
            try {
                const formData = new FormData();   //This is used to add image file to the request as it is binary data and image file can not be requested as stringify.json;It also append the regular text
